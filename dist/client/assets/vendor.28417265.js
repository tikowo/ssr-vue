...
const toDisplayString = (val) => {
  return val == null ? "" : isArray(val) || isObject$1(val) && val.toString === objectToString ? JSON.stringify(val, replacer, 2) : String(val);
};
...
export { Fragment as F, RouterView as R, Suspense as S, createVNode as a, renderSlot as b, createElementBlock as c, createTextVNode as d, createRouter as e, createWebHistory as f, createStore as g, h, createSSRApp as i, computed as j, createBaseVNode as k, renderList as l, popScopeId as m, defineAsyncComponent as n, openBlock as o, pushScopeId as p, reactive as q, resolveComponent as r, unref as s, toDisplayString as t, useStore as u, defineComponent as v, withCtx as w };
